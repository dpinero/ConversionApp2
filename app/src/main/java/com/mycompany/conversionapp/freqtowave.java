...
public class freqtowave extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_freqtowave);
        Spinner dropdownfreq = (Spinner)findViewById(R.id.spinner1);
        ...
        Spinner dropdownwave = (Spinner)findViewById(R.id.spinner2);
    ...
    public void FreqtoWave(View view) {
        Double testdouble;
       ...
       //  check if first text box is empty
        ...
        Spinner freqdropdown = (Spinner)findViewById(R.id.spinner1);
        Integer freqposition=freqdropdown.getSelectedItemPosition();
        Spinner wavedropdown = (Spinner)findViewById(R.id.spinner2);
        ...
        TextView textView = (TextView) findViewById(R.id.display_message1);
